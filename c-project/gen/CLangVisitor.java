...
public interface CLangVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link CLangParser#declaration}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDeclaration(CLangParser.DeclarationContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link CLangParser#format}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFormat(CLangParser.FormatContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link CLangParser#argumentsList}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitArgumentsList(CLangParser.ArgumentsListContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link CLangParser#commonStr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCommonStr(CLangParser.CommonStrContext ctx);
	/**
